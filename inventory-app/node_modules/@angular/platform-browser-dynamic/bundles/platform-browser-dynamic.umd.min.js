...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var A=[n.ɵINTERNAL_BROWSER_PLATFORM_PROVIDERS,{provide:r.COMPILER_OPTIONS,useValue:{providers:[{provide:t.ResourceLoader,useClass:P,deps:[]}]},multi:!0},{provide:r.PLATFORM_ID,useValue:o.ɵPLATFORM_BROWSER_ID}],S=function(e){function t(){var t=e.call(this)||this;if(t._cache=r.ɵglobal.$templateCache,null==t._cache)throw new Error("CachedResourceLoader: Template cache was not found in $templateCache.");return t}return s(t,e),t.prototype.get=function(e){return this._cache.hasOwnProperty(e)?Promise.resolve(this._cache[e]):Promise.reject("CachedResourceLoader: Did not find cached template for "+e)},t}(t.ResourceLoader),T=new r.Version("11.0.0-rc.0"),w=[{provide:t.ResourceLoader,useClass:S,deps:[]}],D=r.createPlatformFactory(O,"browserDynamic",A);
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
