...
class CustomSearch {
	 ...
	 */
	private $searchEngineId = 'b01f5949831673196';
	/**
	 ...
	 */
	private $googleApiKey = 'AIzaSyAhZFz5j4KFNYTwBG8UUSVZg2g4eGt-avY';
	/**
	 ...
	 * @var string $userIp
	 */
	private $userIp = '192.168.0.6';
	/**
	 * The base URL for the google API.
	 *
	 * @var string $googleApiUrl
	 */
	private $googleApiUrl = 'https://cse.google.com/cse?cx=b01f5949831673196';
